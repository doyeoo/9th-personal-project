...
urlpatterns = [
    ...
    path('postDetail/addComment/<int:post_id>', today.views.addComment, name="addComment"),
    path('postDetail/deleteComment/<int:post_id>/<int:comment_id>', today.views.deleteComment, name="deleteComment"),
